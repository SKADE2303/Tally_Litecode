		...
		<>
			<main className='bg-blue-950 min-h-screen'>
				...
				<div className='relative overflow-x-auto mx-auto px-6 pb-10'>
					...
					{/** This loops 10 times to display 10 different loading icons */}
					{loadingProblems && (
					...
					<table className='text-sm text-left text-gray-500 dark:text-white sm:w-7/12 w-full max-w-[1200px] mx-auto'>
						{!loadingProblems && (
